...
_DISCLAIMER_HTML = (
    '<div style="background:rgba(241,196,15,0.06);border:1px solid rgba(241,196,15,0.2);'
    'border-radius:6px;padding:8px 14px;margin:10px 0;font-size:0.72rem;color:#8a9ab5;">'
    '⚠️ <strong style="color:#c8a415;">Research tool only.</strong> '
    'Signals are generated by algorithmic rules for informational purposes. '
    'This is not SEBI-registered investment advice. Verify all signals independently '
    'and size positions according to your own risk tolerance. Past performance is not '
...
def research_disclaimer():
    """Render the standard research-tool disclaimer. Call once per signal page."""
