...
def signal_card(signal_dict: dict):
    ...
    ">
        ...
        <div style="
            ...
            background: linear-gradient(90deg, {dir_color}66, transparent 60%);
        "></div>

        <!-- Header row -->
        <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:16px;">
            <div style="display:flex; align-items:center; gap:10px; flex-wrap:wrap;">
                <span style="font-size:1.3rem; font-weight:800; color:#e8eaf0; letter-spacing:-0.02em;">{ticker_short}</span>
                <span style="
                    background:{dir_bg}; color:{dir_color};
                    border:1px solid {dir_border};
                    border-radius:6px; padding:3px 10px;
                    font-size:0.75rem; font-weight:700; letter-spacing:0.07em;
                ">{dir_emoji} {direction}</span>
                <span style="
                    background:rgba(255,255,255,0.05); color:#6b7a99;
                    border-radius:6px; padding:3px 10px;
                    font-size:0.72rem; font-weight:600;
                ">{timeframe}</span>
            </div>
            <div style="text-align:right; flex-shrink:0;">
                <div style="color:#f0b429; font-size:1rem; letter-spacing:3px; line-height:1;">
                    <span style="color:#f0b429;">{stars_filled}</span><span style="color:#2a3050;">{stars_empty}</span>
                </div>
                <div style="color:#6b7a99; font-size:0.7rem; margin-top:4px; font-weight:600; letter-spacing:0.04em;">{strategy}</div>
            </div>
        </div>
        ...
        <div style="display:grid; grid-template-columns:repeat(4,1fr); gap:10px; margin-bottom:16px;">
            ...
            ">
                <div style="color:#6b7a99;font-size:0.62rem;font-weight:700;text-transform:uppercase;letter-spacing:0.09em;margin-bottom:6px;">Entry</div>
                <div style="color:#e8eaf0;font-weight:700;font-size:1.05rem;">₹{entry:,.2f}</div>
            </div>
            <div style="
                ...
                border-radius:10px; padding:12px; text-align:center;
            ">
                <div style="color:#6b7a99;font-size:0.62rem;font-weight:700;text-transform:uppercase;letter-spacing:0.09em;margin-bottom:6px;">Stop Loss</div>
                <div style="color:#ff4d6d;font-weight:700;font-size:1.05rem;">₹{stop:,.2f}</div>
                <div style="color:rgba(255,77,109,0.7);font-size:0.72rem;margin-top:3px;">−{sl_pct:.1f}%</div>
            </div>
            <div style="
                ...
                border-radius:10px; padding:12px; text-align:center;
            ">
                <div style="color:#6b7a99;font-size:0.62rem;font-weight:700;text-transform:uppercase;letter-spacing:0.09em;margin-bottom:6px;">Target 1</div>
                <div style="color:#00c896;font-weight:700;font-size:1.05rem;">₹{t1:,.2f}</div>
                <div style="color:rgba(0,200,150,0.7);font-size:0.72rem;margin-top:3px;">+{t1_pct:.1f}%</div>
            </div>
            <div style="
                ...
                border-radius:10px; padding:12px; text-align:center;
            ">
                <div style="color:#6b7a99;font-size:0.62rem;font-weight:700;text-transform:uppercase;letter-spacing:0.09em;margin-bottom:6px;">Target 2</div>
                <div style="color:#4ade80;font-weight:700;font-size:1.05rem;">₹{t2:,.2f}</div>
                <div style="color:rgba(74,222,128,0.7);font-size:0.72rem;margin-top:3px;">+{t2_pct:.1f}%</div>
            </div>
        </div>
        ...
        ">
            <span style="color:#6b7a99; font-size:0.78rem;">
                {name}
                <span style="color:#3a4a62; margin:0 4px;">·</span>
                <span style="color:#8a9ab8;">{sector}</span>
            </span>
            <span style="
                background:rgba({('0,200,150' if rr>=2 else '240,180,41')},0.12);
                color:{rr_color};
                border:1px solid rgba({('0,200,150' if rr>=2 else '240,180,41')},0.25);
                border-radius:6px; padding:3px 10px;
